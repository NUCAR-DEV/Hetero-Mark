#ifndef HMM_EMGAMMAHSALAUNCHER_H
#define HMM_EMGAMMAHSALAUNCHER_H

#include "../common/HsaKernelLauncher.h"

class EmGammaHsaLauncher : public HsaKernelLauncher
{
...
public:
	 ...
	 * Constructor
	 */
	EmGammaHsaLauncer(HsaHelper *helper) : 
