...
/* THIS FILE:  /home/yifan/Hetero-Mark/hsa/micro-benchmark/caching/kernels.h  */
/* INPUT FILE: /home/yifan/Hetero-Mark/hsa/micro-benchmark/caching/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void accessOnce(unsigned long length,unsigned int* in,unsigned int* out, const snk_lparm_t * lparm);
extern _CPPSTRING_ void accessOnce_init(const int printStats);
extern _CPPSTRING_ void accessTwice(unsigned long length,unsigned int* in,unsigned int* out, const snk_lparm_t * lparm);
extern _CPPSTRING_ void accessTwice_init(const int printStats);
