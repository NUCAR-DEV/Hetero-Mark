...
/* THIS FILE:  /home/yifan/hetero_mark/src/hsa/aes_hsa/kernels.h  */
/* INPUT FILE: /home/yifan/hetero_mark/src/hsa/aes_hsa/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void sb_st(size_t in_size, const snk_lparm_t * lparm);
extern _CPPSTRING_ void sb_st_init(const int printStats);
extern _CPPSTRING_ void mc(size_t arr_size, const snk_lparm_t * lparm);
extern _CPPSTRING_ void mc_init(const int printStats);
extern _CPPSTRING_ void sr(size_t in_size, const snk_lparm_t * lparm);
extern _CPPSTRING_ void sr_init(const int printStats);
extern _CPPSTRING_ void ark(size_t state_size,unsigned int* eK,int strD, const snk_lparm_t * lparm);
extern _CPPSTRING_ void ark_init(const int printStats);
extern _CPPSTRING_ void CLRunnerntrl(unsigned char* in,unsigned int* eK, const snk_lparm_t * lparm);
extern _CPPSTRING_ void CLRunnerntrl_init(const int printStats);
