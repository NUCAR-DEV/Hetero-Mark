...
//                                       Forward kernels
//-----------------------------------------------------------------------------------------------//
__kernel void FWD_init_alphaKernel(const int    N,
                             __global float *b,
...
__kernel void  FWD_norm_alphaKernel(const int N,
								const int startpos,
								__local  float *sm,
								__global float *alpha,
								__global float *lll)
...
__kernel void TransposeSymKernel (const int N,
                            __local float *sm,
                            __global float *a,
							__global float *aT)
{
...
//                                         Backward kernels
//-----------------------------------------------------------------------------------------------//
__kernel void BK_BetaBKernel(const int N,
                       const int pos,
...
__kernel void BK_norm_betaKernel(const int N,
						   const int current,
						   __local  float *sm,
						   __global float *beta)
...
__kernel void EM_betaB_alphabetaKernel(const int N,
                                const int current, 
                                const int previous,
								__global const float *beta, 
								__global const float *b, 
...
__kernel void EM_update_gammaKernel(const int N,
                              const int current,
							  __local float *sm,
...
// Compute alpha * betaB'  
__kernel void EM_alpha_betaBKernel(const int N,
                                  const int current,
...
__kernel void EM_pre_xisumKernel(const int N,
		                   __local        float *sm,
...
__kernel void EM_update_xisumKernel(const int N,
                              const float sum,
...
// TODO
__kernel void EM_gammaKernel(const int N,
                              const int current,
							  __local float *sm,
                              __global const float *alpha, 
                              __global const float *beta, 
...
__kernel void EM_expectAKernel(const int N,
                          __local float *sm,
...
__kernel void EM_gamma_state_sumKernel(const int N,
                                 const int T,
								 __local float *sm,
...
__kernel void EM_expect_muKernel(const int D,
                           const int T,
						   const int offset,
						   const int hs,
						   __local float *sm,
