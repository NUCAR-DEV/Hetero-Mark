...
set( FOLDER_NAME BENCHNAMELOWER_hsa )
set( SUBDIRECTORIES )
set( SRC_FILES 
  main.cc
  BENCHNAMELOWER_hsa_benchmark.h
  BENCHNAMELOWER_hsa_benchmark.cc
)
set( HEADER_FILES )
set( TEST_FILES )
set( EXTRA_FILES 
...
if (have_snack AND HSA_RUNTIME)
  ...
  target_link_libraries(${FOLDER_NAME}
      BENCHNAMELOWER time_measurement command_line_option benchmark ${HSA_RUNTIME})
