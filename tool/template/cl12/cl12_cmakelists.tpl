set( BENCHMARK_NAME BENCHNAMELOWER_cl12 )
set( SOURCE_FILES BENCHNAMELOWER_cl12_benchmark.cc main.cc )
set( HEADER_FILES BENCHNAMELOWER_cl12_benchmark.h )
...
if ( OPENCL_INCLUDE_DIRS AND OPENCL_LIBRARIES )
  ...
  target_link_libraries( ${BENCHMARK_NAME} 
      BENCHNAMELOWER cl_util time_measurement command_line_option benchmark 
      ${OPENCL_LIBRARIES})
