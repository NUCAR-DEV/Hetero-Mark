...
filter is calculated on the device, and the result is transferred back to
the host.
...
* Page Rank - PageRank is an algorithm used by Google Search to rank
...
* Black Scholes - The Black–Scholes or Black–Scholes–Merton model is
