...
benchmarks = [
    ...
    ('ep', 'hc', ['-x', '256', '-m', '100', '-c']),
    ('ep', 'hc', ['-x', '512', '-m', '100', '-c']),
    ('ep', 'hc', ['-x', '1024', '-m', '100', '-c']),
    ('ep', 'hc', ['-x', '2048', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '32', '-m', '100']),
    ('ep', 'cuda', ['-x', '64', '-m', '100']),
    ('ep', 'cuda', ['-x', '128', '-m', '100']),
    ('ep', 'cuda', ['-x', '256', '-m', '100']),
    ('ep', 'cuda', ['-x', '512', '-m', '100']),
    ('ep', 'cuda', ['-x', '1024', '-m', '100']),
    ('ep', 'cuda', ['-x', '2048', '-m', '100']),
    ('ep', 'cuda', ['-x', '32', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '64', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '128', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '256', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '512', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '1024', '-m', '100', '-c']),
    ('ep', 'cuda', ['-x', '2048', '-m', '100', '-c']),
